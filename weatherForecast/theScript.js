...
$(document).ready(function(){
    ...
    let appid="&appid=23cd9d36af59ba6f32ce21fcf0cd68f4";
    ...
    function displayWeatherData() {
        ...
        if (weatherData.weather[0].main=="Clouds") {
            $(".pimg3").css("background-image", "url('img/rain1.jpeg')");
            console.log("coldsss");
            
        }
       else if(weatherData.weather[0].main=="Clear"){ 
           $(".pimg3").css("background-image", "url('img/mountain1.jpeg')");
            console.log("hottt");
        }
        else if(weatherData.weather[0].main=="Thunderstorm"){ 
            $(".pimg3").css("background-image", "url('img/thunderStorm.jpeg')");
             console.log("thunderstorm");
        }
        else if(weatherData.weather[0].main=="Haze"){ 
            $(".pimg3").css("background-image", "url('img/haze.jpeg')");
             console.log("haze");
        }
        else if(weatherData.weather[0].main=="Rain"){ 
            $(".pimg3").css("background-image", "url('img/rain3.jpeg')");
             console.log("haze");
        }
        else if(weatherData.weather[0].main=="Mist"){ 
            $(".pimg3").css("background-image", "url('img/mist.jpg')");
             console.log("haze");
        }
           
        else{ 
            $(".pimg3").css("background-image", "url('img/forest1.jpeg')");
             console.log("normal");
        }
